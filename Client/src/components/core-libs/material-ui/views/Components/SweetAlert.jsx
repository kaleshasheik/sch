            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  <h5>Basic example</h5>
                  <Button color="info" onClick={this.basicAlert.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  ...
                  <Button color="info" onClick={this.successAlert.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  ...
                  <Button color="info" onClick={this.htmlAlert.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  ...
                  <Button color="info" onClick={this.autoCloseAlert.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
            ...
            <Card>
              <CardBody>
                <div className={classes.center}>
                  ...
                  <Button color="info" onClick={this.inputAlert.bind(this)}>
                    Try me!
                  </Button>
                </div>
              </CardBody>
